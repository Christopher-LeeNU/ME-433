...
void init_mpu6050(void) {
    ...
    write_byte_I2C1(IMU_ADDR, CONFIG, 0x00); // clearing
    write_byte_I2C1(IMU_ADDR, CONFIG, 0x7); // 0b0111 for low pass thing0b0
    ...
    // write_byte_I2C1(IMU_ADDR,ACCEL_CONFIG,0x03); // setting to +/- 16g
